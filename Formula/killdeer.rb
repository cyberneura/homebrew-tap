class Killdeer < Formula
  ...
  # The url spells the version out rather than interpolating `version`, which is
  # declared after it. scripts/update.py moves both on together.
  url "https://github.com/cyberneura/killdeer/releases/download/v0.2.3/killdeer-macos.zip"
  version "0.2.3"
